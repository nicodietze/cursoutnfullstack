        ...
        <section className="holder">
            <div className="historia">
                ...
                <p>El proyecto Caja de Rimas surgió en 2018 como una idea pequeña que fue creciendo y se
                        ...
                        a los lectores que teníamos pensados: niños y niñas en su segunda infancia. Ideados para leer en familia 
                        y estimular la imaginación, la empatia, la reflexión y el pensamiento.</p>
            </div>
            <br></br>
            <br></br>
            ...
            <div className="personas">
                <div className="persona">
                    <img src="images/nosotros/nosotros1.jpg" alt="Autor" />
                    <h5>Nicolás A. Dietze</h5>
                    <h6>Autor</h6>
                    <p>Mi nombre es Nicolás Alejandro Dietze, tengo 35 años, soy profesor de Historia
                ...
                <div className="persona">
                    <img src="images/nosotros/nosotros2.jpg" alt="Ilustrador" />
                    <h5>Juan Manuel Corvalan</h5>
                    <h6>Ilustrador</h6>
                    <p>Mi nombre es Juan Manuel Corvalán, tengo 34 años, desde adolescente 
                ...
                <div className="persona">
                    <img src="images/nosotros/nosotros3.jpg" alt="Diseñadora" />
                    <h5>Gabriela ...</h5>
                    <h6>Diseñadora</h6>
